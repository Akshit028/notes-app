        ...
        <div className="p-4">
            ...
            <div className="mt-8 grid grid-cols-1 gap-4 md:grid-cols-2">
                {categories.map((category) => (
                    <Card
                        className="group relative mb-4 flex items-center justify-between gap-2 transition-shadow hover:shadow-lg"
                        key={category.id}
                    >
                        <CardHeader
                            onClick={() => handleCategoryClick(category)}
                            className="line-clamp-1 flex cursor-pointer flex-row items-start justify-between space-y-0"
                        >
